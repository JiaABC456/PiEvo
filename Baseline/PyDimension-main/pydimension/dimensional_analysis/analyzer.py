...
class DimensionalAnalyzer:
    ...
    def load_data(self, normalized_data, full_matrix, variable_names) -> Tuple[pd.DataFrame, np.ndarray]:
        """Load normalized data and dimension matrix from CSV files."""

        self.normalized_data = normalized_data
        self.normalized_data = pd.DataFrame(normalized_data, columns=variable_names)
        ...
        self.dimension_matrix = full_matrix[:, :-1]
    ...
    def process(self, normalized_data, full_matrix, variable_names):
        # Load data
        self.load_data(normalized_data, full_matrix, variable_names)
        # Find basis vectors
        self.find_basis_vectors()
        # Create dimensionless variables
        data = self.create_dimensionless_variables()
        
        return data, self.basis_vectors
